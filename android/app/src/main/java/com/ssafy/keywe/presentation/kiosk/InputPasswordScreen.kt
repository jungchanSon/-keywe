            ...
            Column(
                ...
                Box(
                    ...
                    Text(modifier = Modifier.padding(top = 40.dp, bottom = 10.dp),
                        text = "인증 번호를 입력해주세요.", style = h6.copy(letterSpacing = 0.sp)
                    )
                }
                // 인증번호 입력 필드
                Row(
                        ...
                        Box(
                            ...
                            Text(
                                text = when {
                                    ...
                                    index == inputPassword.length - 1 -> inputPassword.lastOrNull()?.toString() ?: ""
                                    else -> "-"
                                },
                                fontSize = 24.sp,
                ...
                KeypadScreen(
                    ...
                    onConfirmClick = {
                        if (inputPassword.length == 4) {
                            navController.navigate(Route.MenuBaseRoute.WaitingRoomRoute("1","1","1"))
                        }
                    },
                    onBackClick = {
