...
import com.ssafy.keywe.webrtc.ui.ChannelNameInput
import com.ssafy.keywe.webrtc.ui.DropdownMenuRaw
import com.ssafy.keywe.webrtc.ui.SliderRaw
import com.ssafy.keywe.webrtc.ui.SwitchRaw
import com.ssafy.keywe.webrtc.ui.TwoVideoView
import com.ssafy.keywe.webrtc.ui.TwoVideoViewType
...
fun ScreenSharing() {
        ...
        RtcEngine.create(RtcEngineConfig().apply {
            ...
            mEventHandler = object : IRtcEngineEventHandler() {
                ...
                override fun onLeaveChannel(stats: RtcStats?) {
                    ...
                    Log.d("ScreenSharing", "onLeaveChannel: $stats")
                    isJoined = false
                    localUid = 0
    ...
    ScreenSharingView(channelName = channelName,
        isJoined = isJoined,
        localUid = screenUid,
        remoteUid = remoteUid,
...
private fun ScreenSharingView(
    ...
    Column {
        ...
        SwitchRaw(
            title = "화면 공유", checked = isScreenPreview, enable = isJoined && isScreenSharing
        ) {
            onScreenPreview(it)
        }
        SwitchRaw(
            title = "오디오", enable = isJoined && isScreenSharing
        ) {
            onScreenAudio(it)
        }
        DropdownMenuRaw(
            title = "Scenario Type", options = listOf(
        ...
        SliderRaw(
            title = "Capture Volume", value = 1.0f, enable = isJoined && isScreenSharing
        ) {
            onScreenVolume(it)
        }
        ChannelNameInput(
...
private fun ScreenSharingViewPreview() {
    ScreenSharingView(channelName = "test",
        isJoined = false,
        localUid = 1,
        onJoinClick = {},
        onLeaveClick = { },
