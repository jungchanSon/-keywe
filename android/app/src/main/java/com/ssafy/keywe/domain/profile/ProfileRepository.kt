...
interface ProfileRepository {
    suspend fun getAllProfile(): ResponseResult<GetAllProfileModel>
    ...
    suspend fun patchProfile(profileId: Long, patchProfileRequest: PatchProfileRequest): ResponseResult<PatchProfileModel>
